...
class _HomeState extends State<Home> {
  ...
  String voiceinit =
    ...
    String onLongPressVoice= "please wait some seconds, we are looking for a volunteer ";
    String onTapVoice = "please ap twice to  acesse the smart system , hold for 5 seconds  to request a volunteer ";
          ...
          child: Column(
            ...
            Expanded(child :Container(
              ...
              child: Center(
                child : Column(
                  children: [
                    SizedBox(height: 50,),
                    Text("descriptif",style: TextStyle(
                    ...
                    Container(
                      ...
                      child:  Text("brEYEn, or Brain Eye is a solution that assists blind and partially blind people to work in public places safely at any time",
                    ...
                    Container(
                      ...
                      child: Text("this is funct 1",style: TextStyle(
                        color: Colors.white,
                        fontWeight: FontWeight.w600
                      ),),
                    ),
            ...
            Container(
              child: GestureDetector(
                ...
                child : Image(image: AssetImage("images/clickFinger.png"),
                ),
                decoration: BoxDecoration(
                  border: Border(
