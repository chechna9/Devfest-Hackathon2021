                  ...
                  child:  Center(child:
                     SingleChildScrollView(
                       child: Column(         
                         children: [
                           SizedBox(height: 40,),
                           Text("Login", style: TextStyle(color: Color(0xFF1597E5),fontWeight: FontWeight.bold , fontSize: 24),),
                            SizedBox(height: 50,),
                            ...
                            SizedBox(height: 40,),
                            Container(child: Text("Login",style: TextStyle(
                              color: Colors.white ,
                              fontWeight: FontWeight.w600,
                              fontSize: 16
                            ),),
                             ...
                             Container(child: Text("Forget Your password",style: TextStyle(
                               color: Color(0xFF1597E5),
                               fontWeight: FontWeight.w500,
                               fontSize: 14
                             ),),),
                             SizedBox(height: 15,),
                             Container(child: Text("you don't have an acount",style: TextStyle(
                               color: Color(0xFF1597E5),
                               fontWeight: FontWeight.w500,
                               fontSize: 14
                             ),),),
